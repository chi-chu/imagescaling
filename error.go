...
var (
    ...
    ERRSCALE            = errors.New("[Scale Mode] only support ProportionMode or CustomMode or FixLengthMode")
    ...
    ERRNILSCALEMODE     = errors.New("[Scale Mode] is nil Or you forget to Set Global Scale Mode")
    ...
    ERRNILCLIPMODE      = errors.New("[Clip Mode] is nil Or you forget to Set Global Clip Mode")
)
